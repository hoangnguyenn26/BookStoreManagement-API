...
namespace Bookstore.Application.Interfaces.Services
{
    ...
    {
        Task<IEnumerable<UserDto>> GetAllUsersAsync(int page = 1, int pageSize = 10, string? roleFilter = null, bool? statusFilter = null, string? searchQuery = null, CancellationToken cancellationToken = default);
